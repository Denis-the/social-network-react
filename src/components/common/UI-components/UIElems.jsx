...
export const ButtonUI = ({ children, className, ...props }) => {
  ...
  return (
    <ButtonBase {...props} className={btnClass}>
      {children}
    </ButtonBase>
  );
};
...
export const SelectUI = ({ children, className, onChange, ...props }) => {
  ...
  return (
    <select onChange={onSelect} className={selectClass} {...props}>
      {children}
    </select>
  );
};
    ...
    <div className="p-panel p-component p-panel-toggleable">
      <div className="p-panel-header">
        ...
        <div className="p-panel-icons">
          ...
          >
            <span
              className={classNames("pi", isOpen ? "pi-minus" : "pi-plus")}
            />
      ...
      {isOpen ? (
        <div
          ...
          aria-hidden="false"
        >
          <div className="p-panel-content">{body}</div>
        </div>
      ) : null}
    </div>
  );
