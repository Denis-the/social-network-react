            ...
            {({ form, handleSubmit, submitError }) => (
                <form onSubmit={handleSubmit}>
                    <div className='p-d-inline-flex'>
                        <Field name='term' component={InputFE} id='Search Term' className='p-inputtext-sm p-shadow-3' />
                        <Field name='followed' component={SingleSelectButtonsFE} id='SearchFollowed'
                            className='p-d-inline-flex p-button-sm p-shadow-3' disabled={isFetching}
                        ...
                        <Field name='submit' component={ButtonFE} type='submit' className='p-shadow-3'>Search</Field>
                    </div>
                </form>
            )}
        </Form>
...
const UsersSearchPanel = React.memo(({ ...props }) => {
    ...
    return (
        <div className="users__search-panel">
            ...
            <UsersSearchForm {...props} submitAction={requestUsersHandler.requestUsers}/>
        </div>
    )
})
